...
<body>
	...
	<ol>
		...
		<li>RO API specification: <a
			href="http://www.rohub.org/wiki/display/docs/RO+API+6">http://www.rohub.org/wiki/display/docs/RO+API+6</a></li>
		<li>RO Evolution management service: <a href="${it.roevosuri}">${it.roevouri}</a></li>
		<li>RO Evolution management API specification: <a
			href="http://www.rohub.org/wiki/display/docs/RO+evolution+API">http://www.rohub.org/wiki/display/docs/RO+evolution+API</a></li>
		<li>RODL Portal: <a
			href="http://www.rohub.org/portal/">http://www.rohub.org/portal/</a></li>
	</ol>
	<hr />
	<p style="font-size: small">Running RODL ${it.version}.</p>
</body>
</html>
