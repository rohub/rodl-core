...
import org.rohub.rodl.eventbus.lazy.LazyEventBusModule;
...
import org.rohub.rodl.model.ROEVO.Change;
import org.rohub.rodl.model.ROEVO.ChangeSpecification;
import org.rohub.rodl.model.ROEVO.ForkEvoInfo;
import org.rohub.rodl.model.ROEVO.ImmutableEvoInfo;
import org.rohub.rodl.model.ROEVO.ImmutableResearchObject;
import org.rohub.rodl.model.ROEVO.LiveEvoInfo;
import org.rohub.rodl.model.ROEVO.Change.ChangeType;
import org.rohub.rodl.storage.DigitalLibraryFactory;
import org.rohub.rodl.storage.FilesystemDLFactory;
import org.rohub.rodl.vocabulary.W4E;
...
public class Builder {
    ...
    public ForkEvoInfo buildForkEvoInfo(URI uri, ResearchObject researchObject, UserMetadata creator, DateTime created) {
        ForkEvoInfo evoInfo = new ForkEvoInfo(user, dataset, useTransactions, researchObject, uri);
        evoInfo.setCreator(creator);
        evoInfo.setCreated(created);
        evoInfo.setBuilder(this);
        evoInfo.setEvoType(EvoType.FORK);
        return evoInfo;
    }
