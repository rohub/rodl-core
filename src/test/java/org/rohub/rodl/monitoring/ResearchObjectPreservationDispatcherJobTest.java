...
import org.rohub.rodl.monitoring.ResearchObjectPreservationDispatcherJob;
...
public class ResearchObjectPreservationDispatcherJobTest extends AbstractUnitTest {
    ...
    public final void testExecute()
            throws JobExecutionException {
        ResearchObjectPreservationDispatcherJob job = new ResearchObjectPreservationDispatcherJob();
        ...
        for (JobDetail jobDetail : answer.getJobs().keySet()) {
            rosScheduled.add((URI) jobDetail.getJobDataMap().get(PreservationJob.RESEARCH_OBJECT_URI));
        }
