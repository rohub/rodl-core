...
public class ResearchObjectTest extends AbstractUnitTest {
    ...
    public void testAggregate()
        ...
        org.rohub.rodl.model.RO.Resource r = ro.aggregate("resource.txt", is, "text/plain");
    ...
    public void testResourceCopy()
        ...
        InputStream is = getClass().getClassLoader().getResourceAsStream("model/ro/research_object/resource.txt");
        org.rohub.rodl.model.RO.Resource r = ro.aggregate("resource.txt", is, "text/plain");
        org.rohub.rodl.model.RO.Resource result = researchObject.copy(r, new SnapshotBuilder());
    ...
    public void testAnnotate()
        ...
        org.rohub.rodl.model.RO.Resource body = ro.aggregate("body.rdf", is, "application/rdf+xml");
